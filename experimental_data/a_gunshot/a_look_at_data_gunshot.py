...
print('If you decimate, you must choose N so that the new sampling frequency is as small as possible, but nonetheless greater than 2*fmax')
print(' ')
...
print('\n'*20)
print('This is the spectrogram, computed with a sliding window of length 51 samples')
